...
"@
        ...
        Convert_RetentionAnomalyDetected = "ВНИМАНИЕ: {0} из {1} файлов к удалению выглядят свежими (созданы/изменены после {2}). Это может означать сброс даты на устройстве."
        Convert_RetentionAnomalyItem     = "  ! {0} (дата: {1}, создан/изменён: {2}, источник: {3})"
        Convert_RetentionAnomalyMore     = "  ... ещё {0}"
        Convert_RetentionAnomalyPrompt   = "Удалить файлы несмотря на несоответствие дат? (Y/N)"
        Convert_RetentionRenameCandidates = "Папки, которые можно переименовать на сегодняшнюю дату:"
        Convert_RetentionRenamePrompt     = "Переименовать эти папки на сегодняшнюю дату ({0})? (Y/N)"
        Convert_RetentionRenameItem       = "  -> {0} -> {1}"
        Convert_RetentionRenameDone       = "Переименовано папок: {0}"
...
"@
        ...
        Convert_RetentionAnomalyDetected = "WARNING: {0} of {1} deletion candidates look recently created/modified (after {2}). This may indicate a device clock reset."
        Convert_RetentionAnomalyItem     = "  ! {0} (effective: {1}, created/modified: {2}, source: {3})"
        Convert_RetentionAnomalyMore     = "  ... +{0} more"
        Convert_RetentionAnomalyPrompt   = "Delete files anyway despite the date mismatch? (Y/N)"
        Convert_RetentionRenameCandidates = "Folders that can be renamed to today's date:"
        Convert_RetentionRenamePrompt     = "Rename these folders to today's date ({0})? (Y/N)"
        Convert_RetentionRenameItem       = "  -> {0} -> {1}"
        Convert_RetentionRenameDone       = "Folders renamed: {0}"
