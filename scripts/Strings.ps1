...
"@
        ...
        Convert_RetentionAnomalyItem     = "  ! {0} (дата: {1}, создан/изменён: {2}, источник: {3})"
        Convert_RetentionAnomalyMore     = "  ... ещё {0}"
        Convert_ClockResetNoticeSynced   = "Замечен сброс даты на устройстве. Дата уже синхронизирована, но видео содержат некорректную дату."
        Convert_ClockResetNotice         = "Замечен сброс даты на устройстве. Видео содержат некорректную дату."
        Convert_ClockResetCount          = "Файлов с некорректной датой: {0}."
        Convert_ClockResetPrompt         = "Действие: [T] Поставить сегодняшнюю дату, [D] Удалить как устаревшее, [S] Пропустить (Enter = пропустить)"
        Convert_ClockResetInvalid        = "Неизвестный ответ. Введите T, D или S."
        Convert_ClockResetSkipped        = "Файлы со сброшенной датой оставлены без изменений."
        Convert_ClockResetDeleted        = "Удалено файлов со сброшенной датой: {0}."
        Convert_ClockResetRenamedFile    = "  -> {0} -> {1}"
        Convert_ClockResetRenamedFolder  = "  -> {0} -> {1}"
        Convert_ClockResetRenameDone     = "Дата в именах обновлена на {0}. Папок: {1}, файлов: {2}."
...
"@
        ...
        Convert_RetentionAnomalyItem     = "  ! {0} (effective: {1}, created/modified: {2}, source: {3})"
        Convert_RetentionAnomalyMore     = "  ... +{0} more"
        Convert_ClockResetNoticeSynced   = "Device clock reset detected. The clock is already synchronized, but the videos still have an incorrect date."
        Convert_ClockResetNotice         = "Device clock reset detected. The videos have an incorrect date."
        Convert_ClockResetCount          = "Files with an incorrect date: {0}."
        Convert_ClockResetPrompt         = "Action: [T] Set today's date, [D] Delete as outdated, [S] Skip (Enter = skip)"
        Convert_ClockResetInvalid        = "Unknown answer. Enter T, D, or S."
        Convert_ClockResetSkipped        = "Files with a reset date were left unchanged."
        Convert_ClockResetDeleted        = "Deleted {0} file(s) with a reset date."
        Convert_ClockResetRenamedFile    = "  -> {0} -> {1}"
        Convert_ClockResetRenamedFolder  = "  -> {0} -> {1}"
        Convert_ClockResetRenameDone     = "Names now use {0}. Folders: {1}, files: {2}."
